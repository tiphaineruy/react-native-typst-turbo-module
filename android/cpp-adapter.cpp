...
// Automated testing checks Java_com_typstturbomodule_TypstTurboModuleModule and typstturbomodule
// by comparing the whole line here.
/*
Java_com_typstturbomodule_TypstTurboModuleModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return typstturbomodule::multiply(a, b);
}
*/

// Installer coming from TypstTurboModuleModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_typstturbomodule_TypstTurboModuleModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return typstturbomodule::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_typstturbomodule_TypstTurboModuleModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return typstturbomodule::cleanupRustCrate(*runtime);
}